...
class Task():
    ...
    def __init__(self, init_pose=None, init_velocities=None, 
        ...
        self.start_position = self.sim.pose[:3]
    ...
    def get_reward(self):
        ...
        reward -= abs(current_position[0]-self.target_pos[0])*20
        reward -= abs(current_position[1]-self.target_pos[1])*20
        
        # add reward if getting closer to target and substract from reward if reaches beyond target.
        if self.target_pos[2]>=current_position[2]:
            reward += 1000/(self.target_pos[2]-current_position[2])
        else:
            reward -= (current_position[2]-self.target_pos[2])*100
